...
class Review():
    def __init__(self, review_content: str, rating: int, review_image: str, user_id: ObjectId, business_id: ObjectId, review_timestamp: float = time.time(), upvotes = 0, downvotes = 0):
