...
class Review():
    def __init__(self, review_content: str, rating: int, user_id: ObjectId, business_id: ObjectId, review_timestamp: float = None, upvotes = 0, downvotes = 0, trusted_review = False):
